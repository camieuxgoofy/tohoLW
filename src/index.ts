...
export const characters = writable<Character[]>([
  ...
  },
  {
    ...
    species: "Vampire",
    ability: "Destroying absolutely anything and everything",
    titles: "The Sister of the Scarlet Devil, Embodiment of the Scarlet Devil",
    threatLevel: "Unknown",
    friendlinessToHumans: "Low",
    mainLocation: "Scarlet Devil Mansion",
    charImage: new URL("p_flandre.jpg", imageDirUrl).href,
  },
  {
    name: "Alice Margatroid",
    species: "Magician",
    ability: "Capable of handling dolls",
    titles: "Seven-Colored Puppeteer",
    threatLevel: "Unknown",
    friendlinessToHumans: "Normal",
    mainLocation: "The Forest of Magic",
    charImage: new URL("p_alice.jpg", imageDirUrl).href,
  },
  // {
  //   name: "zxc",
  //   species: "qwe",
